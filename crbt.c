...
int main(int argc, char** argv) {
  ...
  if (!strcmp(argv[1], "-c")) {
    ...
    header* H = read_classbench_header_list(argv[3]);
    /* print_header_list(H); */

    list_mrule* R = read_classbench_rule_list(argv[2]);
    /* list_mrule_print(R); */
    ...
    header* H = read_header_list(argv[2]);
    /* print_header_list(H); */

    list_mrule* R = read_mrule_list(argv[1]);
    /* list_mrule_print(R); */
